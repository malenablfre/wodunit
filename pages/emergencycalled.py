...
class emergencycalled(ft.UserControl):
    ...
    def show_dialog(self, e):
        dialog = ft.AlertDialog(
            title=ft.Text("Möchtest du wirlich ein Emergency Meeting ausrufen?!", style=ft.TextStyle(font_family="Times New Roman", color="#EE4540",)),
            bgcolor="#801336",
            actions=[
