...
class voting_room(ft.UserControl):
    def __init__(self, page):
        ...
        self.button_submit_vote = ft.TextButton(
            text="Stimme abgeben",
    ...
    # ------ choosing your vote ------
    def create_suspect_radio(self, name):
        return ft.Radio(
            value= name,
            label=name,
    ...
    def enable_vote_button(self, e):
        self.button_submit_vote.disabled = False
        self.main_suspect = self.suspect_radio.value
        self.page.update()


    # ------ VOTING DIALOGUE ------
    def show_dialog(self, e):
        self.suspect_radio = ft.RadioGroup(
            content=ft.Column(
                scroll=ft.ScrollMode.HIDDEN,
                height= 100,
                controls=[self.create_suspect_radio(name) for name in self.suspects]
            ),
            on_change=self.enable_vote_button
        )
    ...
    def close_dialog(self, e):
        ...
        self.all_votes.append(self.main_suspect)
