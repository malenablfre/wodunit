...
class Emergency2(ft.UserControl):
    ...
    def show_dialog(self, e):
        dialog = ft.AlertDialog(
            title=ft.Text("Du kannst keine Emergency Meeting ausrufen, da breits schon ein Meeting ausgerufen wurde", style=ft.TextStyle(font_family="Times New Roman", color="#EE4540",)),
            bgcolor="#801336",
            actions=[
